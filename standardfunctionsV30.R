...
#'date: "16 mars 2017"
#'abstract: |
#'      This is the code of the standard functions v20.
#'       
#'      * make.result  modified
#'      * makeresname added
#'      * main functions return values modified)
#'      * + many other changes
#'      
#'output:
#'  html_document:
...
play_cat1 <- function(res, hastitle = TRUE, custom = FALSE, 
        ...
        newline()
        cat(pander(res$ptable, caption = varnames)) 
        newline(1)
        # displaygraph(multiplot(res$plot, res$plot1, cols = 1))
        displaygraph(res$plot1)
        newline()
}
